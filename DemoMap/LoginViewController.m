...
- (void)viewDidLoad {
    ...
    [self.logInView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"strip-map-app_v3.png"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.logInView.logo setFrame:CGRectMake(120.0f, 70.0f, 80.0f, 58.5f)];
    
//    [self.logInView.logInButton setFrame:CGRectMake(66.5f, 240.0f, 187.0f, 58.5f)];
    
//    [self.logInView.facebookButton setFrame:CGRectMake(35.0f+65.0f, 287.0f, 120.0f, 40.0f)];
