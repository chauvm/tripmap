...
- (void)viewDidLoad {
    ...
    [self.signUpView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"strip-map-app_v3.png"]]];
...
- (void)viewDidLayoutSubviews {
    ...
    [self.signUpView.logo setFrame:CGRectMake(120.0f, 70.0f, 80.0f, 58.5f)];
