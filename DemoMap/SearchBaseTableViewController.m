...
//NSString *const kCellIdentifier = @"SearchStationTableCell";
...
- (void)configureCell:(UITableViewCell *)cell forStation:(Station *)station {
    ...
    Direction *dir = [station valueForKeyPath:@"directionStations.self"];
    cell.detailTextLabel.text = [NSString stringWithFormat:@"%@, FROM %@", dir.line, dir.name];
