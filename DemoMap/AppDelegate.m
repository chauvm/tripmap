...
@property (nonatomic, strong) LinesListTableViewController *lltvc;
@property (nonatomic, strong) DataImporter *importer;
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // Initialize Parse.
    [Parse setApplicationId:@"in1ouXpokSTHZ0a1CC1CM6NRMBCuUWkUHVdDTcR6"
                  clientKey:@"poY4lSdGZJlCmjluzdTXSYKPrzUYOoU5mMMj8tSf"];
    ...
    BOOL hasData = [userDefaults boolForKey:@"CityData"];
    if (!hasData) {
        // do delete core data here
        ...
        self.importer = [[DataImporter alloc] init];
...
+ (UIColor*)lightYellowColor {
    // rgb(255, 255, 240)
    return [UIColor colorWithRed:255.0f/255.0f green:255.0f/255.0f blue:250.0f/255.0f alpha:0.7f];
}

+ (UIColor*)lightGrayColor {
    // rgb(238, 238, 238)
    return [UIColor colorWithRed:248.0f/255.0f green:248.0f/255.0f blue:248.0f/255.0f alpha:0.7f];
}
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"DemoMap.sqlite"];
